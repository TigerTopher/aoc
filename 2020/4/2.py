...
def check_valid(details):
    ...
    if(not(len(details["byr"]) == 4 and int(details["byr"]) >= 1920 and int(details["byr"]) <= 2002 )):
        return False
    
    if(not(len(details["iyr"]) == 4 and int(details["iyr"]) >= 2010 and int(details["iyr"]) <= 2020)):
        return False
    
    if(not(len(details["eyr"]) == 4 and int(details["eyr"]) >= 2020 and int(details["eyr"]) <= 2030)):
        return False
    ...
    if(not (details["hcl"][0] == "#" and check_if_hex(details["hcl"][1]))):
        return False
